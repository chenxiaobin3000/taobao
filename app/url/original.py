...
url_original = [
    ...
    path('api/user_deduction/delAll', user_deduction.deleteAll),
    ...
    path('api/user_fake/delAll', user_fake.deleteAll),
    ...
    path('api/user_order/delAll', user_order.deleteAll),
    ...
    path('api/user_polymerize/delAll', user_polymerize.deleteAll),
    ...
    path('api/user_promotion_detail/delAll', user_promotion_detail.deleteAll),
    ...
    path('api/user_promotion/delAll', user_promotion.deleteAll),
    ...
    path('api/user_purchase/delAll', user_purchase.deleteAll),
    ...
    path('api/user_transfer/delAll', user_transfer.deleteAll),
