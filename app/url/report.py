...
from app.views.report import board_report, day_report, fake_report, good_radar, good_report, order_report, omission_report, promotion_report, purchase_report, year_report
