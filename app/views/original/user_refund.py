...
def getList(request):
    ...
    total = UserRefund.objects.total(user_id, shop_id, start_date, end_date, search)
    refunds = UserRefund.objects.getList(user_id, shop_id, page, num, start_date, end_date, search)
