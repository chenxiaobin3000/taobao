...
# 聚合支付表
class UserPolymerizeManager(models.Manager):
    def add(self, user_id, shop_id, order_id, finance_type, amount, amount_type, create_time, polymerize_note):
        return self.create(user_id=user_id, shop_id=shop_id, order_id=order_id, finance_type=finance_type, amount=amount, amount_type=amount_type, create_time=create_time, polymerize_note=polymerize_note)
...
class UserPolymerize(models.Model):
    objects = UserPolymerizeManager()
