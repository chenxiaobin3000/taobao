...
# 推广明细表
class UserPromotionDetailManager(models.Manager):
    def add(self, user_id, shop_id, promotion_date, good_id, show_num, click_num, click_rate, cost, average_cost, thousand_cost, deal_amount, deal_num, deal_cost, shop_cart, favorites, roi):
        return self.create(user_id=user_id, shop_id=shop_id, promotion_date=promotion_date, good_id=good_id, show_num=show_num, click_num=click_num, click_rate=click_rate, cost=cost, average_cost=average_cost, thousand_cost=thousand_cost, deal_amount=deal_amount, deal_num=deal_num, deal_cost=deal_cost, shop_cart=shop_cart, favorites=favorites, roi=roi)
...
class UserPromotionDetail(models.Model):
    objects = UserPromotionDetailManager()
