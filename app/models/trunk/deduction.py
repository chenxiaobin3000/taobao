...
class DeductionManager(models.Manager):
    ...
    def getAllByDate(self, shop_id, start_date, end_date):
        return list(self.filter(shop_id=shop_id, create_time__gte=start_date, create_time__lt=end_date).values('order_id', 'amount', 'amount_type', 'create_time', 'deduction_note'))

    def getAllByIds(self, shop_id, order_ids, start_date, end_date):
        return list(self.filter(shop_id=shop_id, order_id__in=order_ids, create_time__gte=start_date, create_time__lt=end_date).values('order_id', 'amount', 'amount_type', 'create_time', 'deduction_note'))
