...
export default {
  ...
  children: [{
    ...
    name: 'original_deductionDiscard', meta: { title: '扣费过滤', roles: [3006] }
  }, {
    ...
    name: 'original_polymerizeDiscard', meta: { title: '聚合过滤', roles: [3008] }
  }, {
    ...
    name: 'original_refund_gift', meta: { title: '退货过滤', roles: [3010] }
  }, {
