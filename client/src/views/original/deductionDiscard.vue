<template>
  <div class="app-container">
    ...
    <pagination v-show="total>0" :total="total" :page.sync="listQuery.page" :limit.sync="listQuery.num" @pagination="getUserDeductionDiscardList" />
  </div>
</template>
...
export default {
  ...
  watch: {
    search(newVal, oldVal) {
      ...
      this.getUserDeductionDiscardList()
    }
  },
  mounted: function() {
    setTimeout(() => {
